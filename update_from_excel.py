...
book = xlrd.open_workbook(r"C:\Documents\Needham\Green Needham\Projects\Solarize Plus\Roof_Survey_Table_for_Needham_DB.xlsx")
...
#
# Set an update query
update_query = ("UPDATE needham.RESIDENCE SET rs_pv_potl = %s WHERE rs_street_number like %s AND rs_street_name LIKE %s")
#
...
for r in range(1, sheet.nrows):
  ...
  pv_potl = sheet.cell(r,2).value

  values = (pv_potl, st_num, st_name)
  print (f" {st_num} {st_name} has solar potential = {pv_potl} ")
